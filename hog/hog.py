...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    #     score0 += take_turn(dice_roll0, score1, dice)
    ...
    #         score1 += take_turn(dice_roll1, score0, dice)
    #         # print(pig_pass(score1, score0))
    #         # print(swine_align(score1,score0))
    #         # print(extra_turn(score1,score0))
    #         while extra_turn(score1, score0) and score1 < goal:
    #             # score1 += take_turn(dice_roll1, score0, dice)
    #             score1 += dice()
    def take_extra_turn(strategy,player_score, opponent_score, goal, dice, player, say):
        while extra_turn(player_score, opponent_score):
            ...
            if player == 0:
                say = say(player_score, opponent_score)
            else:
                say = say(opponent_score, player_score)
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0, say= take_extra_turn(strategy0, score0, score1, goal, dice, who, say)
        else:
            score1 += take_turn(strategy1(score1,score0), score0, dice)
            say = say(score0, score1)
            score1, say= take_extra_turn(strategy1, score1, score0, goal, dice, who, say)
        who = other(who)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def say(score0, score1, in_last_score = last_score, in_running_high = running_high):
        new_score = score0 if who == 0 else score1 
        # print("new_score:",new_score)
        new_get_score = new_score - in_last_score
        # print("new_get_score:",new_get_score)

        if new_get_score > in_running_high:
            print(new_get_score,"point(s)! The most yet for Player", who)
            in_running_high = new_get_score
        last_score = new_score

        return announce_highest(who, last_score, in_running_high)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    max_average_score, number = -1, -1

    for i in range(1, 11):
        averaged = make_averaged(roll_dice, trials_count)
        average_score = averaged(i, dice)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if (score + opponent_score) / 2 < 40:
        return extra_turn_strategy(score, opponent_score, 8, 5)
    else:
